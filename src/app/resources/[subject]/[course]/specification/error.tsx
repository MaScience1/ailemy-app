...
export default function SpecificationError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error("[/resources/[subject]/[course]/specification] route error", error);
  }, [error]);
    ...
    <main className="flex min-h-screen items-center justify-center bg-parchment px-6 text-ink">
      <div className="max-w-md text-center">
        ...
        <h1 className="font-display mt-4 text-3xl font-medium tracking-tight md:text-4xl">
          We couldn&apos;t load this specification.
        </h1>
        <p className="mt-4 text-sm text-ink/65">
          Try again, or return to the course&apos;s resources.
        </p>
