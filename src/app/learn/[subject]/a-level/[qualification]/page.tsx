...
/**
 * /learn/[subject]/a-level/[qualification] — step 3, the exam-board choice.
 *
...
export async function generateMetadata({ params }: { params: Params }): Promise<Metadata> {
  ...
  const name = qualificationName("a-level", qualification);
  return {
...
export default async function Page({ params }: { params: Params }) {
  ...
  return <BoardStep subjectSlug={subject} level="a-level" scope={qualification} />;
}
