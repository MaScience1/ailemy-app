...
/**
 * /learn/[subject]/gcse — step 2 of the flow (§23).
 *
 * ⚠ A STATIC SEGMENT BESIDE [pathway], AND THAT IS LOAD-BEARING. Next sorts
 * literal children above dynamic ones, so this wins /learn/chemistry/gcse
 ...
 *
 * This URL 404'd before today (isPathway rejects "gcse"), so nothing that
...
export default async function Page({ params }: { params: Params }) {
  ...
  return <QualificationStep subjectSlug={subject} level="gcse" />;
}
